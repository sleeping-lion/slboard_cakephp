...
class BlogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'blog_category_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'blog_comments_count' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'index_blogs_on_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'index_blogs_on_blog_category_id' => ['type' => 'index', 'columns' => ['blog_category_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'count' => 1,
            'enable' => 1,
            'created_at' => '2016-09-12 02:09:05',
            'updated_at' => '2016-09-12 02:09:05'
        ],
    ];
}
