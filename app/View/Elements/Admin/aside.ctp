<aside>
  ...
  <li role="presentation" class="dropdown <?php if(!strcmp($this->params['controller'],'faq_categories') OR !strcmp($this->params['controller'],'gallery_categories') OR !strcmp($this->params['controller'],'blog_categories')): ?><?php echo " active" ?><?php endif ?>">
