<aside>
	<nav>
		<ul class="nav nav-pills nav-stacked">
			...
			<li <?php if($this->params['controller']=='faqCategories'): ?>class="active"<?php endif ?>><?=$this -> Html -> link(_('Faq Category'), array('controller' => 'faq_categories', 'action' => 'index')); ?></li>										
			...
			<li <?php if($this->params['controller']=='galleryCategories'): ?>class="active"<?php endif ?>><?=$this -> Html -> link(_('Gallery Category'), array('controller' => 'gallery_categories', 'action' => 'index')); ?></li>
			...
			<li <?php if($this->params['controller']=='blogCategories'): ?>class="active"<?php endif ?>><?=$this -> Html -> link(_('Blog Category'), array('controller' => 'blog_categories', 'action' => 'index')); ?></li>				
